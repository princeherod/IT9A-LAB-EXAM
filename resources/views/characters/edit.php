        ...
        <div class="card-body">
            <form action="{{ route('characters.update', $character) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="power" class="form-control @error('power') is-invalid @enderror" value="{{ old('power', $character->power) }}">
                    @error('power') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="mb-3">
                    <label class="form-label">Universe</label>
                    <input type="text" name="universe" class="form-control @error('universe') is-invalid @enderror" value="{{ old('universe', $character->universe) }}">
